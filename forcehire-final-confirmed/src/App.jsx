...
export default function ForceHireLanding() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-800 to-black p-6 flex flex-col items-center justify-center text-white font-['Orbitron']">
      <motion.div
      ...
      >
        <div className="relative inline-block mb-8 w-64 h-72 mx-auto">
          <img
            src="/shield.png"
            alt="Shield"
            className="absolute inset-0 w-full h-full object-contain z-0"
          />
          <h1 className="text-4xl font-extrabold text-white relative z-10 pt-24">
      ...
      >
        <div className="bg-white text-black shadow-xl rounded-xl p-8">
